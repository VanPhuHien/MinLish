  ...
  useEffect(() => {
    ...
    const fetchAdminData = async () => {
      try {
        ...
        setError(
          err.response?.data?.message || "Không thể lấy thông tin admin",
        );
      }
    };
    fetchAdminData();
        ...
        <div className="row">
          ...
          <div className="col-md-8 mt-4 mt-md-0">
            <ul className="list-group list-group-flush rounded bg-secondary">
              <li className="list-group-item bg-secondary text-white border-dark">
              ...
              <li className="list-group-item bg-secondary text-white border-dark">
                <strong>Phone:</strong> {data.profile?.phone || "Chưa cập nhật"}
              </li>
              <li className="list-group-item bg-secondary text-white border-dark">
                <strong>Giới tính:</strong>{" "}
                {data.profile?.gender || "Chưa cập nhật"}
              </li>
              <li className="list-group-item bg-secondary text-white border-dark">
                <strong>Bio:</strong> {data.profile?.bio || "Chưa cập nhật"}
              </li>
            </ul>
          </div>
        </div>
