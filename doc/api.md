...
| `battle:error` | `{ code }` | Lỗi: `INVALID_MODE`, `ROOM_NOT_FOUND`, `HOST_DISCONNECTED`, `MATCH_NOT_FOUND` |
...
| Hành động | XP |
| :-- | :-- |
| Tham gia trận (battle_play) | +15 XP cho cả 2 |
| Thắng trận (battle_win) | +35 XP cho người thắng |

XP idempotent: gọi finalize nhiều lần không bị cộng trùng.
