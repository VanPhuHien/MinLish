...
| `tagIds` | Các tags |
| `cefrLevelIds` | Các mức cerf\_levels |
...
| `topicId` | Card thuộc nhóm nào trong deck (deck\_topics ). |
...
user\_segment\_progress (“Bảng này lưu tiến độ của user ở mức từng segment. Vì Dictation và Shadowing diễn ra theo từng câu”)
